...
function fnFormatBorrowingOverrides( $tbl, nTr, anOpen )
{
    ...
    sOut = sOut+'<tr><td><button id="bNoFurtherSources" class="override-button">No further sources</button></td><td>if there are no furher sources for you to try.<br/>An override message will be added to the request, and it will be closed and moved to history.</td></tr>';
