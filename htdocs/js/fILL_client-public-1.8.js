...
function my_onshow(data) {
	...
	$recDiv.append( $('<a href="#" id="rec_'+hit.recid+'" onclick="showDetails(this.id);return false;"><b>'+hit["md-title"] +' </b></a>') ); 
...
function secondaryDetails(data) {
    var secondary = '<table class="secondary_info" style="display: none; width: 100%; background-color: #f5f5f5; font-size: .7em; color: #505050;">';  // start new table for location info
...
//	}
	...
	if (data["location"][i]["md-medium"] != undefined) {
	    secondary += '<tr><td><b>Format</b></td><td><b>:</b> <b><font style="background-color: yellow;">' + data["location"][i]["md-medium"] + '</font></b></td></tr>';
