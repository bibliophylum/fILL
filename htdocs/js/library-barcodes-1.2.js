...
function build_table( data ) {
    ...
    cell = document.createElement("TH"); cell.innerHTML = "oid"; row.appendChild(cell);
    ...
    for (var i=0;i<data.barcodes.length;i++) 
    {
        row = tBody.insertRow(-1); row.id = data.barcodes[i].oid+'_'+data.barcodes[i].borrower;
        cell = row.insertCell(-1); cell.innerHTML = data.barcodes[i].oid;
        cell = row.insertCell(-1); cell.innerHTML = data.barcodes[i].borrower;
        cell = row.insertCell(-1); cell.innerHTML = data.barcodes[i].symbol;
        cell = row.insertCell(-1); cell.innerHTML = data.barcodes[i].org_name;
