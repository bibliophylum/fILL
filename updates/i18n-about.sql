...
('public/about.tmpl','en','js_lang_data','about-p2',null,'If you are unable to find an item after searching your library''s catalogue you can use fILL to find it online and have it delivered to your local public library.'),
...
('public/about.tmpl','fr','js_lang_data','about-p1',null,'fILL est le système de gestion des prêts entre bibliothèques utilisé par toutes les bibliothèques publiques du Manitoba. Il relie votre bibliothèque locale aux millions d’articles accessibles dans les bibliothèques du Manitoba.'),
...
('public/about.tmpl','fr','js_lang_data','about-p3',null,'fILL permet aux usagers des bibliothèques de consulter rapidement, facilement et simultanément les catalogues d’un grand nombre de bibliothèques publiques du Manitoba. Lorsque vous trouvez l’article que vous souhaitez demander, fILL prépare la demande de prêt entre bibliothèques pour votre bibliothèque publique et le personnel de la bibliothèque locale pour tenter d’emprunter l’article de la bibliothèque de prêt en votre nom.'),
