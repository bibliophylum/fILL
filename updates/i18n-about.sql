...
('public/about.tmpl','fr','js_lang_data','about-p1',null,'fILL est le système de gestion des prêts interbibliothèques utilisé pour toutes les bibliothèques publiques du Manitoba. Il relie votre bibliothèque locale aux millions d’articles accessibles dans les bibliothèques du Manitoba.'),
...
('public/about.tmpl','fr','js_lang_data','about-p3',null,'fILL permet aux usagers des bibliothèques de consulter rapidement et facilement les catalogues d’un grand nombre de bibliothèques publiques du Manitoba simultanément. Lorsque vous trouvez l’article que vous souhaitez demander, fILL prépare la demande de prêt interbibliothèques pour votre bibliothèque publique et le personnel de la bibliothèque locale pour tenter d’emprunter l’article à la bibliothèque de prêt en votre nom.'),
