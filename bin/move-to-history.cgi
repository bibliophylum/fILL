...
eval {
	...
	$SQL = "insert into history_group (group_id, copies_requested, title, author, medium, requester, note, patron_generated, isbn, pubdate) select group_id, copies_requested, title, author, medium, requester, note, patron_generated, isbn, pubdate from request_group where group_id=?";
