...
sub myaccount_settings_process {
    ...
    $template->param(pagetitle     => "fILL MyAccount Settings",
		     ...
		     borrower_internal_notes_enabled => $href->{borrower_internal_notes_enabled},
		     rows_per_page        => $href->{rows_per_page},
		     logo_path     => $logoPath,
